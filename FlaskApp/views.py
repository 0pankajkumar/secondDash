...
def archivedPostings():
	...
	return render_template('archivedPostings.html', activateDropdownsAndTable="yes", postingDepartment=["dummy"], postingArchiveStatus=["dummy"], profileArchiveStatus=["dummy"], lastUpdated=getLastUpdatedTimestamp(), adminOptions=adminOptions, loginOption=loginOption, teamOptions=teamOptions, archivedPostingHighlight="active", customFilterNames=customFilterNames)
